...
export const Ledger: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    ledgerHash: {
      ...
      example:
        "655EB9D740CC572BFFEC725ABB0AA0D813AAF01C91F8577076F29258794D9445",
    },
    ledgerIndex: {
      type: "integer",
      description:
    ...
    parentLedgerHash: {
      ...
      example:
        "45E963AA7A3BB017D626D088C91E6C646B6BBF558DD027AAD974CBBE9A3977D3",
    },
    accountHash: {
      type: "string",
      description:
      ...
      example:
        "43DA3A81948A7392D14E4DDFB8215372C4B0590E3B28691C599296E4478B12AC",
    },
    totalCoins: {
      type: "string",
      description:
    ...
    transactionHash: {
      ...
      example:
        "8BAD7583234AC463E09D6CF160E352DFF5B008FC071DD5226A53809D89E7F409",
    },
    transactionCount: {
      type: "integer",
      description:
...
export const Memo: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    memoData: {
      type: "string",
      description:
        "메모의 내용을 포함하는 임의의 16진수 문자열입니다. 자유롭게 입력할 수 있습니다.",
      example: "72656e6577206d656d6f",
    },
    memoFormat: {
      type: "string",
      description:
        "메모의 인코딩 방식을 설명하는 16진수 문자열입니다. 일반적으로 MIME 타입을 지정하는 데 사용됩니다.",
  ...
  oneOf: [
    {
      ...
      properties: {
        ...
        tradingFee: {
          type: "integer",
          description:
            "1/100,000 단위로 설정되는 거래 수수료 비율을 나타냅니다. 1은 0.001%, 최대값은 1000(1%)입니다.",
          example: 250,
        },
        effectivePrice: {
          ...Amount,
          description:
            "AMMDeposit에서 유효한 최대 가격을 설정합니다. AMMWithdraw에서는 최소 보장 가격을 설정합니다.",
        },
        lpTokenIn: {
          ...Amount,
        ...
        lpTokenOut: {
          ...Amount,
          description:
            "AMM 풀에 유동성을 공급한 대가로 발행되는 LP 토큰의 수량을 나타냅니다.",
        },
        bidMin: {
          ...Amount,
          description:
        ...
        bidMax: {
          ...Amount,
          description:
            "최대 입찰 금액을 설정합니다. 입찰 금액이 bidMax를 초과하면 트랜잭션이 실패합니다.",
        },
        authAccounts: {
          type: "array",
          description:
          ...
          example: [
            "rEqFohwoXqGFVik15uqF5nBdzfd5qEFh1X",
    ...
    },
    {
      ...
      properties: {
        ...
        paths: {
          ...
          example: [
            [{ account: "rNyMZc18D4yRonb2D9MCjhcHxn8yx9gr31", type: 1 }],
          ],
        },
        sendMax: {
          ...Amount,
...
export const Transfer: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    ...
    transactionHash: {
      ...
      example:
        "4770851929AD74B3EF36D818C7100564B2F3333AE60FA1B05BFAA95020D18D5B",
    },
    transactionType: {
      type: "string",
      description:
...
export const Transaction: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    ...
    sequence: {
      type: "integer",
      description:
        "계정에서 발행한 트랜잭션의 순차 번호로, 중복 제출이나 재생 공격을 방지하기 위해 사용됩니다.",
      example: 94536309,
    },
    lastLedgerSequence: {
      type: "integer",
    ...
    signingPubKey: {
      type: "string",
      description:
        "트랜잭션 서명에 사용된 공개키로, 보통 33바이트(66자리 16진수) 압축된 공개키 형식으로 표현됩니다.",
      example:
        "ED1BCAE2B5F146BF30F40D36D4D8565A7E6F758B7062288336BE74D969E4543A19",
    },
    txnSignature: {
      type: "string",
      description:
        "signingPubKey으로 생성된 트랜잭션 서명 값입니다. 해당 서명은 트랜잭션 검증 및 인증에 사용됩니다.",
      example:
        "744E21E3E298BC06B874EA43ABDEB762A23EEA3630F6DD4215AD32C7B35C2C630777DDC3687245766E3CA7BF0B747A085E44",
    },
    fee: {
      type: "string",
      description:
    ...
    accountTxnId: {
      ...
      example:
        "D84B7A07E9FAD27D8782DAF4A5AD8C8C4D1D1F18E9D62D0384A2E1A2A4D3AD11",
    },
    sourceTag: {
      type: "integer",
