...
export const Transaction: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    ...
    typeUrl: {
      type: "string",
      description: `트랜잭션 유형의 구체적인 경로를 지정하는 필드입니다. 이 필드는 체인 버퍼(chain Buffers) 형식으로 정의된 트랜잭션 유형을 식별하는데 사용됩니다. `,
    },
    isMultiSig: {
      type: "boolean",
...
- 예시: SUCCESS, REVERT, BAD_JUMP_DESTINATION, OUT_OF_MEMORY, PRECOMPILED_CONTRACT, ...`,
    ...
    energyUsage: {
      type: "string",
      description: `트랜잭션을 생성한 계정에서 사용된 에너지(Energy)의 양입니다. `,
    },
    originEnergyUsage: {
      type: "string",
...
<strong style='color: red;'>*</strong> withDecode가 true인 경우에만 제공되는 필드입니다.`,
      properties: {
        ...
        eventFragment: {
          type: "string",
          description: `이벤트의 프래그먼트 또는 간단한 형태의 시그니처입니다.`,
        },
        signature: {
          type: "string",
        ...
        args: {
          ...
          items: {
            ...
            properties: {
              name: {
                type: "string",
                description: `이벤트 인자의 이름을 나타냅니다.`,
              },
              type: {
                type: "string",
                description: `이벤트 인자의 데이터 타입을 나타냅니다.`,
              },
              value: {
                type: "string",
                description: `이벤트 인자의 값을 나타냅니다.`,
              },
            },
          },
        },
    ...
    callValueInfo: {
      ...
      items: {
        ...
        properties: {
          value: {
            type: "string",
            description: `전송된 TRX 또는 TRC10 자산의 수량입니다.`,
          },
          assetId: {
            type: "integer",
