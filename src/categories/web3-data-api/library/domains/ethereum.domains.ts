...
export const NftMeta: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    tokenId: {
      type: "string",
      description:
        "NFT 토큰의 고유 ID를 나타내는 필드입니다. 이 ID는 해당 NFT를 식별하는 데 사용됩니다.",
    },
    tokenUri: {
      type: "string",
      description:
...
export const NftMetaAllRequired: OpenAPIV3.SchemaObject = {
  type: "object",
  required: [
    "tokenId",
    "tokenUri",
  ...
  properties: {
    ...
    rawMetadata: {
      type: "string",
      description: "NFT의 rawMetadata를 나타내는 필드입니다.",
    },
    metadataSyncedAt: {
      type: "string",
      description: "NFT의 metadata가 동기화 된 시점을 나타내는 필드입니다.",
    },
  },
};
...
export const TokenMarketData: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    currency: {
      type: "string",
      description:
        "거래에 사용되는 통화의 종류를 나타냅니다. ISO 4217 통화코드 형식으로 제공됩니다.",
      pattern: Patterns.iso4217.source,
    },
    price: {
      type: "string",
      description:
        "토큰의 현재 가격을 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    volumeFor24h: {
      type: "string",
    ...
    updatedAt: {
      type: "string",
      description:
        "데이터가 업데이트된 시간을 나타내는 필드입니다. 이 필드는 ISO 8601 형식으로 제공됩니다.",
...
const selector: OpenAPIV3.SchemaObject = {
  type: "string",
  description:
    "호출된 함수를 식별하는 4바이트 함수 셀렉터 값입니다. 함수 셀렉터는 함수 시그니처를 Keccak-256 해싱한 결과의 앞 4바이트를 의미합니다. 0x로 시작하는 8자리의 16진수 문자열 형태로 제공됩니다.",
...
export const Function: OpenAPIV3.SchemaObject = {
  type: "object",
  description:
    "Transfer가 포함된 트랜잭션에서 호출된 함수의 정보를 나타내는 필드입니다. 이 필드는 withFunction 파라미터에 true를 입력한 경우에만 응답에 포함됩니다.",
  ...
  properties: {
    ...
    input: {
      type: "string",
      description:
        "함수의 입력 데이터를 나타내는 필드입니다. 0x로 시작하는 16진수 문자열 형태로 제공됩니다.",
...
export const Block: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    hash: {
      type: "string",
      description:
        "블록 해시를 나타내는 필드입니다. 0x로 시작하는 64자리 16진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.prefixedHexaDecimal64.source,
    },
    number: {
      type: "integer",
      description:
        "블록 번호 또는 블록 높이를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    timestamp: {
      type: "integer",
      description:
        "블록이 생성된 시간을 나타내는 필드입니다. 이 필드는 UNIX 타임스탬프로 제공됩니다.",
    },
    parentHash: {
      type: "string",
      description:
    ...
    withdrawals: {
      type: "array",
      description:
        "검증자가 스테이킹한 자산을 출금한 목록을 나타내는 필드입니다.",
      items: {
        type: "object",
        ...
        properties: {
          ...
          validatorIndex: {
            type: "string",
            description:
              "출금을 요청한 검증자의 인덱스를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
            pattern: Patterns.string.decimal().source,
          },
          address: {
            type: "string",
          ...
          amount: {
            type: "string",
            description:
              "출금한 수량을 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
            pattern: Patterns.string.decimal().source,
          },
        },
      },
  ...
  properties: {
    ...
    topics: {
      ...
      items: {
        type: "string",
        description:
          "로그의 토픽을 나타내는 필드입니다. 0x로 시작하는 64자리 16진수 문자열 형태로 제공됩니다.",
        pattern: Patterns.string.prefixedHexaDecimal64.source,
      },
    },
  },
...
export const GasPrice: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    high: {
      type: "string",
      description:
        "현재 Gas Price의 최고가를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    average: {
      type: "string",
      description:
        "현재 Gas Price의 평균가를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    low: {
      type: "string",
      description:
        "현재 Gas Price의 최저가를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    latestBlock: {
      type: "string",
      description:
        "최신 블록을 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    baseFee: {
      type: "string",
      description:
        "최신 블록의 기본 수수료를 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
  },
};
...
네이밍 규칙: \`call_{blockNumber}_{transactionIndex}_{depth1's callOrder}_{depth2's callOrder}_{...}\``,
    ...
    traceIndex: {
      type: "integer",
      description:
        "트랜잭션의 트레이스 인덱스를 나타내는 필드입니다. external transaction의 경우 0을 반환합니다.",
    },
    transactionHash: {
      type: "string",
      description:
    ...
    value: {
      type: "string",
      description:
        "트랜잭션에서 전송된 수량을 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    traceType: {
      type: "string",
      description:
        "트랜잭션의 트레이스 타입을 나타내는 필드입니다. call, create 등이 있습니다.",
    },
    callType: {
      type: "string",
      description:
        "트랜잭션의 호출 타입을 나타내는 필드입니다. call, delegatecall, staticcall 등이 있습니다.",
    },
    gas: {
      type: "string",
      description:
        "트랜잭션에 할당된 가스의 양을 나타내는 필드입니다. 10진수 문자열 형태로 제공됩니다.",
      pattern: Patterns.string.decimal().source,
    },
    gasUsed: {
      type: "string",
    ...
    resolver: {
      ...
      properties: {
        ...
        contentHash: {
          ...
          example:
            "ipfs://bafybeidy7lrjeghrpsg3z7i5yrpfekyo6d3jetv6qofgtixsjumdthetw4",
        },
        text: {
          type: "object",
          description:
          ...
          example: {
            ...
            description:
              "This is an example ENS domain for demonstration purposes.",
    ...
    registration: {
      ...
      properties: {
        ...
        cost: {
          type: "string",
          description:
            "도메인의 등록 비용을 나타내는 필드로 단위는 Wei입니다. 10진수 문자열 형태로 제공됩니다.",
          pattern: Patterns.string.decimal().source,
        },
      },
    },
...
export const AccountStats: OpenAPIV3.SchemaObject = {
  ...
  properties: {
    transactionCounts: {
      type: "object",
      description:
        "조회하는 address와 연관된 트랜잭션 개수 정보를 갖고 있는 객체입니다.",
      properties: {
        external: {
          type: "number",
          description:
            "조회하는 address가 from 또는 to 필드에 포함된 external transaction 개수를 의미합니다.",
        },
        internal: {
          type: "number",
          description:
            "조회하는 address가 from 또는 to 필드에 포함된 internal transaction 개수를 의미합니다.",
        },
      },
    },
    transferCounts: {
      type: "object",
      description:
        "조회하는 address와 연관된 전송 이벤트 개수 정보를 갖고 있는 객체입니다.",
      properties: {
        tokens: {
          type: "number",
          description:
            "조회하는 address가 from 또는 to 필드에 포함된 ERC20 토큰 transfer 이벤트 개수를 의미합니다.",
        },
        nfts: {
          type: "number",
          description:
    ...
    assets: {
      type: "object",
      description:
        "조회하는 address가 소유한 자산 정보를 갖고 있는 객체입니다.",
      properties: {
        tokens: {
          type: "number",
          description:
            "조회하는 address가 보유한 ERC20 토큰 종류 수를 의미합니다.",
        },
        nfts: {
          type: "number",
          description:
            "조회하는 address가 보유한 NFT(ERC721, ERC1155) 개수를 의미합니다.",
        },
        nftContracts: {
          type: "number",
          description:
            "조회하는 address가 소유한 NFT(ERC721, ERC1155) 종류 수를 의미합니다.",
        },
      },
    },
  },
