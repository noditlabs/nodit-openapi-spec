...
const summary = "Get Native Holders";
const endpoint = "getNativeHolders";
const isPublic = true;
...
function getDescription(chain: string): string {
  switch (chain) {
    default:
      return `네이티브 토큰 컨트랙트의 홀더 리스트를 조회합니다. 홀더 리스트에는 홀더의 주소와 홀더가 보유한 토큰의 수량이 포함됩니다.`;
  }
}
    ...
    default:
      return {
        requestBody: {
          ...
          type: "object",
          properties: Requests.PaginationSet.properties,
        },
        successResponse: {
