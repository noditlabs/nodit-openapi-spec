...
import { getChainInfo, XRPL_ACCOUNTS } from "../../../../constants";

const summary = "Get Native Token Balance Changes by Account";
const endpoint = "getNativeTokenBalanceChangesByAccount";
const isPublic = true;
...
function getDescription(protocol: string): string {
	switch (protocol) {
		default:
			return `특정 계정의 네이티브 토큰(XRP) 잔고 변동 내역을 조회합니다.`;
	}
}
	...
	switch (protocol) {
		...
		default:
			return {
				...
				successResponse: {
					schema: Domains.XRPL.BalanceChanges,
