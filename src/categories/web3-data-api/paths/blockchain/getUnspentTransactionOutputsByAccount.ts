...
const summary = "Get Unspent Transaction Outputs By Account";
const endpoint = "getUnspentTransactionOutputsByAccount";
const isPublic = true;
...
function getDescription(protocol: string): string {
  switch (protocol) {
    default:
      return `특정 계정의 UTXO(Unspent Transaction Output) 목록을 조회합니다.`;
  }
}
  ...
  switch (protocol) {
    ...
    default:
      return {
        ...
        successResponse: {
          schema: Domains.Pagination(Domains.Bitcoin.UTXO),
