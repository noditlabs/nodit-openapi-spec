...
const summary = "Get Asset(TRC10) Transfers within Range";
const endpoint = "getAssetTransfersWithinRange";
const isPublic = true;
...
function getDescription(protocol: string): string {
  switch (protocol) {
    ...
    case "tron":
    default:
      return `지정된 기간 동안 발생한 TRC10 토큰 전송 내역을 조회합니다. 만약 해당 기간에 전송 기록이 없으면 빈 배열을 반환합니다.`;
  }
}
