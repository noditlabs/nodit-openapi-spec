...
namespace Responses {
  ...
  export const protocol: OpenAPIV3.SchemaObject = {
    type: "string",
    description:
      "해당 Webhook의 프로토콜을 나타내는 필드입니다. (e.g., ETHEREUM, POLYGON, OPTIMISM, ...)",
  };

  export const network: OpenAPIV3.SchemaObject = {
    type: "string",
    description:
      "해당 Webhook의 네트워크를 나타내는 필드입니다. (e.g., MAINNET, SEPOLIA, MUMBAI, ...)",
  };
  ...
  export const createdAt: OpenAPIV3.SchemaObject = {
    type: "string",
    description:
      "Webhook이 생성된 시간을 나타내는 필드입니다. ISO 8601 형식으로 표현됩니다.",
  };

  export const updatedAt: OpenAPIV3.SchemaObject = {
    type: "string",
    description:
      "Webhook이 수정된 시간을 나타내는 필드입니다. ISO 8601 형식으로 표현됩니다.",
  };
