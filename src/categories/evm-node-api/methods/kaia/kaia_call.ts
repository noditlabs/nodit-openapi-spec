...
import { API_KEY, BASE_URL, ERC20, ETHEREUM_ACCOUNTS, getChainInfo } from "../../../../constants";
								...
								schema: {
									...
									properties: {
										...
										params: {
											...
											maxItems: 3,
											items: {
												oneOf: [Schemas.callObject, Schemas.blockNumberOrHashOrTagKaia, Schemas.stateOverrideSet],
											},
											default: [
												{
													to: ERC20.USDC.CONTRACT_ADDRESS,
													data: `0x70a08231000000000000000000000000${ETHEREUM_ACCOUNTS.VITALIK_BUTERIN.slice(2)}`, // balanceOf(address)
												},
												"latest",
											],
