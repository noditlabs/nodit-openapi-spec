...
export function getChainInfo(protocol: string): ChainInfo {
	const chainInfo = supportedChains.find((chain) => chain.protocol === protocol);
...
export const supportedApisChains: SupportedApis[] = [
	{
		...
		web3DataApi: [
			...
			{
				category: "ens",
				endpoints: ["getAddressByEnsName", "getEnsNameByAddress", "getEnsRecordByName", "getEnsRecordsByAccount"],
			},
			{
				category: "native",
				endpoints: [
		...
		nodeApi: [
			...
			{
				category: "debug",
				endpoints: ["debug_traceBlockByHash", "debug_traceBlockByNumber", "debug_traceCall", "debug_traceTransaction"],
			},
	...
	},
	{
		...
		nodeApi: [
			...
			{
				category: "bor",
				endpoints: ["bor_getAuthor", "bor_getCurrentProposer", "bor_getCurrentValidators", "bor_getSignersAtHash"],
			},
			{ category: "optimism", endpoints: [] },
			{ category: "kaia", endpoints: [] },
			{ category: "klay", endpoints: [] },
	...
	},
	{
		...
		nodeApi: [
			{
				category: "accounts",
				endpoints: ["getAccount", "getAccountModule", "getAccountModules", "getAccountResource", "getAccountResources"],
			},
			{
				category: "blocks",
		...
		web3DataApi: [],
		webhookApi: ["createWebhook", "updateWebhook", "getWebhook", "deleteWebhook", "getWebhookHistory"],
		streamApi: false,
	},
	{
		chain: "bitcoin",
	...
	},
	{
		...
		web3DataApi: [
			...
			{
				category: "native",
				endpoints: ["getNativeTokenBalanceByAccount", "getNativeTokenBalanceChangesByAccount"],
			},
			{
				category: "token",
				endpoints: [
